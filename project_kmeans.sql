...
--
-- Host: localhost:3306
-- Waktu pembuatan: 02 Apr 2022 pada 01.12
...
--
-- Struktur dari tabel `tanaman_kriteria`
--
...
--
-- Dumping data untuk tabel `tanaman_kriteria`
--
...
--
-- Struktur dari tabel `tanaman_nilai`
--
...
--
-- Dumping data untuk tabel `tanaman_nilai`
--
...
--
-- Indeks untuk tabel `tanaman_kriteria`
--
ALTER TABLE `tanaman_kriteria`
  ADD PRIMARY KEY (`tk_id`);

--
-- Indeks untuk tabel `tanaman_nilai`
--
...
--
-- AUTO_INCREMENT untuk tabel `tanaman_kriteria`
--
ALTER TABLE `tanaman_kriteria`
  MODIFY `tk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT untuk tabel `tanaman_nilai`
--
ALTER TABLE `tanaman_nilai`
