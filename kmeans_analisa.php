...
<!-- Page Wrapper -->
<div class="page-wrapper pt-5 mt-5" style="padding: 3% 0; background-color: #fff">
										...
										<tr>
											...
											<td width="15%">
												...
												<select class="form-control pilih-desa1" name="centroid1" required="required">													
													<?php
													$data = mysqli_query($koneksi,"select * from kecamatan where kecamatan_id = 33");		
										...
										<tr>
											...
											<td width="15%">
												...
												<select class="form-control pilih-desa2" name="centroid2" required="required">													
													<?php
													$data = mysqli_query($koneksi,"select * from kecamatan where kecamatan_id = 31");		
													while($d=mysqli_fetch_array($data)){
														?>
														<option value="<?php echo $d['kecamatan_id'] ?>"><?php echo $d['kecamatan_nama'] ?></option>
														<?php
										...
										<tr>
											...
											<td width="15%">
												...
												<select class="form-control pilih-desa3" name="centroid3" required="required">													
													<?php
													$data = mysqli_query($koneksi,"select * from kecamatan where kecamatan_id = 29");		
													while($d=mysqli_fetch_array($data)){
														?>
														<option value="<?php echo $d['kecamatan_id'] ?>"><?php echo $d['kecamatan_nama'] ?></option>
														<?php
